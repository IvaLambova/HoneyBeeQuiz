...
public class MainActivity extends Activity {
    ...
    /*
     * Initializing the integer score as a global variable.
     */
    int score = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /*
        * Removes app toolbar at the top to allow for more screen size to work with.
        */
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
       ...
       // Saves the player current quiz score state.
    ...
    public void submitButton(View v) {
        ...
        // Creates a String that gets the typed player's name.
        ...
        // If player name is empty or its length <=0, display a Toast message. Else continue with the score.
        if (playerName.getText().toString().trim().length() <= 0) {
            Toast.makeText(this, R.string.empty_player_name, Toast.LENGTH_LONG).show();
        // If player score >= 5 display Toast message for high score.
        } else if (finalScore >= 5) {
            Toast.makeText(this, answerSummaryHigh.toString(), Toast.LENGTH_LONG).show();
        // If player score < 5 display Toast message for low score.
        } else
            Toast.makeText(this, answerSummaryLow.toString(), Toast.LENGTH_LONG).show();
    }
